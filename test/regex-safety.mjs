...
const cases = [
  ["javascript", String.raw`const f = function() {} / 2; const \u0061 = 1; `, "javascript expression and escapes"],
  ["typescript", "const f = function(): {value: number} { return {value: 1} } / 2; ", "typescript typed bodies"],
  ["tsx", "const f = <T /* gap */,>(x: T) => x; ", "tsx generic trivia"],
  ["html", "<script><!--<script></script>--></script>", "html double-escaped scripts"],
  ["vue", "<p>{{ value } + <span>unfinished ", "vue incomplete interpolation"],
  ["svelte", "<div value={function() {} / 2}>x</div>", "svelte expression division"],
  ["astro", "<a "],
  ["bash", "<<A\nx\n"],
  ...
  ["css", "a "],
  ["css", ".a\n:is(.b,.c) { color /* gap */: red; } ", "css nested selectors"],
  ["css", "a { background: url(a\\)b); } ", "css URL boundaries"],
  ["css", "/*a", "css comment"],
  ["csv", '"a,'],
  ["dart", "$" + "{"],
  ["dart", "/*a", "dart comment"],
  ...
  ["haskell", "{-a"],
  ["html", "<a "],
  ["html", '<script>const x = 1;</script><style>.a { color: red; }</style>', "html embedded bodies"],
  ["html", '<a title="<not-a-tag>" x=y>', "html quoted attributes"],
  ["html", "<!--a", "html comment"],
  ...
  ["java", "/*a"],
  ["javascript", "/*a"],
  ["javascript", "`literal` ", "javascript templates"],
  ["javascript", "/[", "javascript unfinished regex"],
  ["javascript", "value / other; ", "javascript division"],
  ["json", "\n"],
  ["jsx", "<a "],
  ["jsx", "<A>{value + 1}</A>; ", "jsx expressions"],
  ["kotlin", "$" + "{"],
  ...
  ["prisma", '"a'],
  ["python", '"""a'],
  ["python", 'f"{value!r:>{width}}" ', "python f-string fields"],
  ["python", 'f"\\N{', "python incomplete named escape"],
  ["r", '"a'],
  ["regex", "["],
  ["ruby", '#{'],
  ["ruby", "<<A\nx\n", "ruby heredoc"],
  ...
  ["sql", "/*a"],
  ["svelte", "{#if a"],
  ["svelte", '{#if ok}<p title={fn({x: 1})}>{true}</p>{/if}', "svelte nested expressions"],
  ["swift", "\\("],
  ...
  ["toml", "\n"],
  ["tsx", "<a "],
  ["tsx", "<A<T> value={input as T} />; ", "tsx typed expressions"],
  ["typescript", "/*a"],
  ["typescript", "fn<", "typescript unfinished generics"],
  ["vue", "<a "],
  ["vue", '<p :x="value as string">{{fn({x: 1})}}</p>', "vue nested expressions"],
